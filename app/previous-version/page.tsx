import Hero from '@/components/previous-version/hero';
import ClientStories from '@/components/previous-version/client-stories';
import Services from '@/components/previous-version/services';
